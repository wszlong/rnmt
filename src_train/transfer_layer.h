...
public:
	...
	Input_To_Hidden_Layer<dType> *input_layer_bi;
	Hidden_To_Hidden_Layer<dType> *hidden_layer;
	...
	void init_lower_transfer_layer_bi(bool lower_input,bool copy_d_Err_ht,Input_To_Hidden_Layer<dType> *input_layer,Input_To_Hidden_Layer<dType> *input_layer_bi,Hidden_To_Hidden_Layer<dType> *hidden_layer) {
		this->lower_input = lower_input;
		this->copy_d_Err_ht = copy_d_Err_ht;
		this->input_layer = input_layer;
		this->input_layer_bi = input_layer_bi;
		this->hidden_layer = hidden_layer;
	}
