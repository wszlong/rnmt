...
public:
	...
	virtual void update_weights(int time_index) = 0;
	virtual void clear_gradients() = 0;

	virtual void update_learning_rate(dType learning_rate) = 0;
	virtual void adam_switch_sgd() = 0;
	
	virtual void load_weights(ifstream &input) = 0;
	virtual void dump_weights(ofstream &output) = 0;
