...
#PATH_TO_CUDA_INCLUDE=/usr/local/cuda/include
...
PATH_TO_CUDA_INCLUDE=/usr/local/cuda-7.5/include/
PATH_TO_BOOST_INCLUDE=/usr/include/boost/
PATH_TO_CUDA_LIB_64=/usr/local/cuda-7.5/lib64/
PATH_TO_BOOST_LIB=/usr/lib/x86_64-linux-gnu/
PATH_TO_CUDNN_V4_64=/home/lzhou/tools/cudnn4/lib64/
PATH_TO_CUDNN_INCLUDE=/home/lzhou/tools/cudnn4/include/
...
nvcc -DCUDNN_STATIC -O3 \
     ...
     ../src_train_adam_sgd/main.cu -o LongTrain
