...
public:
	...
	Attention_Softmax_Layer *softmax;
	Hidden_To_Hidden_Layer *hidden_layer;

	upper_transfer_layer() {};

	void init_upper_transfer_layer(bool upper_softmax,bool copy_h_t,bool source_side,Attention_Softmax_Layer *softmax,Hidden_To_Hidden_Layer *hidden_layer) {
